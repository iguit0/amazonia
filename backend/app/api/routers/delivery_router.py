...
def calculate(delivery_coordinates: DeliveryCoordinatesRequest) -> str:
    """Calculate the shortest path and elapsed time"""
    # TODO: Implement properly the delivery router
    return {"origin": delivery_coordinates.origin, "pickup": delivery_coordinates.pickup,"destination": delivery_coordinates.destination}
